...
{
    public partial class SpaceCraftsPage
    {
        #region Fields
        ...
        {
            SpaceItems = await SpaceItemsExtensions.ShowListOfSpaceObjects(new List<SpaceItemTypes> { SpaceItemTypes.MANNEDCRAFT, SpaceItemTypes.UNMANNEDCRAFT }, service);
        }
