...
namespace Imi.Project.Mobile.ViewModels.Forms
{
    ...
    public class LoginWithSocialIconViewModel : LoginViewModel
    {
        ...
        /// </summary>
        public LoginWithSocialIconViewModel(ISpaceItemService<SpaceBaseItemViewModel<Guid>> spaceItemService)
        {
            ...
            this.GetStartedWithoutLoginCommand = new Command(StartWithoutLoginClickedAsync);
        ...
        /// <summary>
        /// Gets or sets the property that is bound with an entry that gets the password from user
        /// in the login page.
        /// </summary>
        ...
        /// </summary>
        public Command GetStartedWithoutLoginCommand { get; set; }
        ...
        {
            await CoreMethods.PushPageModel<ForgotPasswordViewModel>(obj);
        }
        ...
        /// <summary>
        /// Invoked when the get started without logging in button is clicked.
        /// </summary>
        /// <param name="obj">The Object</param>
        private async void StartWithoutLoginClickedAsync(object obj)
        {
